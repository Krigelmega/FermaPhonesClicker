...
from AUTOMATIKA.auto.strings import URL_BOOSTS_FOR_BUY, URL_BUY_BOOST, URL_BUY_UPGRADE, \
...
logging.basicConfig(level=logging.INFO, format="HAMSTER %(levelname)s   %(message)s")
